...
from .serializers import HaiguanSerializer
from .models import haiguan
from rest_framework import viewsets

class HaiguanView(viewsets.ModelViewSet):
    serializer_class = HaiguanSerializer
    def get_queryset(self):
        return haiguan.objects.all()
...
#     import requests
#     res = requests.get("http://www.chinaunicom.com.cn/news/202202/1646101193816047802.html")
#     data_list = res.json()
#     print(data_list)
#
